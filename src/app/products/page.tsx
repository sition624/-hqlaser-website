...
export default function ProductsPage() {
  return (
    <>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* HQ26-A */}
            <Link href="/products/hq26a" className="group bg-[#111111] border border-[#222222] rounded-sm overflow-hidden card-hover">
              <div className="aspect-[16/10] bg-[#1a1a1a] relative flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFD60A]/5 to-transparent" />
                <div className="text-center">
                  <svg className="w-20 h-20 mx-auto text-[#333333]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={0.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  <p className="text-[#666666] text-sm mt-2">HQ26-A Product Image</p>
                </div>
                <div className="absolute top-4 left-4 px-3 py-1 bg-[#FFD60A] text-[#0a0a0a] text-xs font-bold uppercase">
                  Best Seller
                </div>
              </div>
              <div className="p-8">
                <h3 className="text-2xl font-bold text-white group-hover:text-[#FFD60A] transition-colors mb-2">
            ...
            {/* HQ-1530 */}
            <Link href="/products/hq1530" className="group bg-[#111111] border border-[#222222] rounded-sm overflow-hidden card-hover">
              <div className="aspect-[16/10] bg-[#1a1a1a] relative flex items-center justify-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[#666666] text-sm mt-2">HQ-1530 Product Image</p>
                </div>
                <div className="absolute top-4 left-4 px-3 py-1 bg-[#00D4FF] text-[#0a0a0a] text-xs font-bold uppercase">
                  Hot Sale
                </div>
              </div>
              <div className="p-8">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {productCategories.map((cat) => (
              <div key={cat.name} className="bg-[#0a0a0a] border border-[#222222] rounded-sm p-8">
                <div className="flex items-start justify-between mb-6">
                  <h3 className="text-xl font-bold text-white">{cat.name}</h3>
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: cat.accent }} />
                </div>
                <p className="text-[#A0A0A0] text-sm mb-6">{cat.desc}</p>
                <ul className="space-y-3 mb-6">
                  {cat.models.map((model) => (
                    <li key={model} className="flex items-center gap-3 text-sm text-[#A0A0A0]">
      ...
      {/* CTA */}
      <section className="py-20 bg-[#0a0a0a] border-t border-[#222222]">
