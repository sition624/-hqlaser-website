        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/86" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#162032] border border-[#2A4A6B] rounded-sm flex items-center justify-center text-[#94A3B8] hover:text-[#25D366] hover:border-[#25D366] transition-colors">
